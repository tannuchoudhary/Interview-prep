...
1. ***Private Cloud*** : ***example***: Your own computer, even all companies have their own private cloud like, IBM, Huwayei, Samsung, MI etc, it can be only used by their own employees.

In private cloud, you have to purchase the hardware and then you have to virtualize it to use it.


 ***advantages***: very much secure, data can be acessed by you only
 ***disadvantages***: you need your own hardware, therfore costly
 
 companies having their own private cloud: Ericson, Huawei, Lenovo, MI, Samsung.
...
e.g Amazon, IBM, Microsoft Azure, Google cloud
...
3. ***Hybrid Cloud*** : contains both public and private cloud, most preferred by companies nowadays so that important data can be kept in private cloud and data like employee data, other day to day data can be kept on public cloud. here both private and public cloud can interact with each other and can share data.
